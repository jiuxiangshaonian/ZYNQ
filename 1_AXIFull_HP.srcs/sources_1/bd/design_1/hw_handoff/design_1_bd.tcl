...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net myip_0_M00_AXI [get_bd_intf_pins myip_0/M00_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins DVI_Transmitter_0/pclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins myip_0/pixel_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins DVI_Transmitter_0/pclk_x5] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net myip_0_video_data [get_bd_pins DVI_Transmitter_0/video_din] [get_bd_pins myip_0/video_data]
  connect_bd_net -net myip_0_video_de [get_bd_pins DVI_Transmitter_0/video_de] [get_bd_pins myip_0/video_de]
  connect_bd_net -net myip_0_video_hs [get_bd_pins DVI_Transmitter_0/video_hsync] [get_bd_pins myip_0/video_hs]
  connect_bd_net -net myip_0_video_vs [get_bd_pins DVI_Transmitter_0/video_vsync] [get_bd_pins myip_0/video_vs]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins DVI_Transmitter_0/reset_n] [get_bd_pins myip_0/m00_axi_aresetn] [get_bd_pins myip_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins myip_0/m00_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces myip_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
